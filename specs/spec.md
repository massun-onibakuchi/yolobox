# Scheduled Agent Runner Specification
...
- `scheduled-agent-runner schedule`
- `scheduled-agent-runner status`
- `scheduled-agent-runner pause`
- `scheduled-agent-runner resume`
- `scheduled-agent-runner edit`
- `scheduled-agent-runner remove`
- `scheduled-agent-runner config get-default-model`
- `scheduled-agent-runner config set-default-model`
- `scheduled-agent-runner run`
