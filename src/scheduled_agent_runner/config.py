...
CONFIG_ENV_VAR = "SCHEDULED_AGENT_RUNNER_CONFIG"
DEFAULT_CONFIG_PATH = Path(".automation/scheduled-agent-runner/config.toml")
...
def load_config(config_path: Path | None = None) -> AppConfig:
    ...
    if not config_path.exists():
        raise FileNotFoundError(
            f"Config file not found at {config_path}. Copy or edit .automation/scheduled-agent-runner/config.toml first."
        )
